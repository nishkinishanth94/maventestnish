...
public class Baseclass {
	...
	public void screenshotCopyFile(File source) throws IOException {
		File destination = new File("C:\\Jayashree java\\MavenTest\\excelsheet\\skills.xlsx");
	...
	public String getData(String sheetName, int rowNum, int cellNum) throws IOException {
		String res = null;
		File file = new File("C:\\Jayashree java\\MavenTest\\excelsheet\\adacin.xlsx");
	...
	public void createData(String sheetName, int rowNum, int cellNum, String Data , String URL) throws IOException {
